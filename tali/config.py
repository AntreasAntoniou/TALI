...
tali_dataset_config = TALIBase.build_config(
    ...
    tali_dataset_dir=TALI_DATASET_DIR,
    modality_list=[
        ModalityTypes.wit_image,
        ModalityTypes.wit_caption,
        ModalityTypes.wit_title,
        ModalityTypes.wit_main_body,
        ModalityTypes.youtube_image,
        ModalityTypes.youtube_video,
        ModalityTypes.youtube_subtitles,
        ModalityTypes.youtube_audio,
        ModalityTypes.youtube_description,
    ],
    rng_seed=42,
    top_k_tali=10,
    image_size=224,
...
def collect_config_store():
    ...
    for value in BaseConfig.__dataclass_fields__s():
        item = (
